        ...
        <div class="modal-dialog" role="document">
                ...
                <div class="modal-content shadow">
                    <div class="modal-header">
                        <a href="Cmessage-view.php?id=<?= $message['data']['id'] ?>" style="text-decoration: none;"><i class="fas fa-fw fa-arrow-left fs-5 text-secondary"></i></a>
                    ...
                    <div class="modal-footer">
                        <a href="Cmessage.php" class="btn btn-danger">Close</a>
