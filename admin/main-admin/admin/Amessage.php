    ...
    <div class="col-sm-5 mt-1 bg-white shadow mb-4 pb-4 m-0" style="height: 62vh; overflow-y: scroll;">
        ...
        <div class="row">
            ...
            <?php 
                ...
                $query = "SELECT * FROM a_message ORDER BY id DESC";
                ...
                if(mysqli_num_rows($message) > 0){
                    foreach($message as $msg){
                        ?>
                            <a href="Amessage-proccess.php?id=<?= $msg['id'] ?>" style="text-decoration: none;" name="msgClicked">
                                ...
                                <div>
                                    <a href="Amessage-delete.php?id=<?= $msg['id']; ?>"
