                   ...
                   <div class="col-md-8">
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" maxlength="6" required name="postal_code">
                            </div>
                            </div>
                    ...
                    <div class="card card-profile shadow-sm">
                        ...
                        <div class="d-flex justify-content-between">
                                <div class="row">
                                    <div class="col-md-12">
                                        <button class="btn text-white float-end" style="background: #495057; width: 100%;" name="saveAdmin">Save Changes</button>
                                    </div>
                                </div>
                        </div>
                        </div>
