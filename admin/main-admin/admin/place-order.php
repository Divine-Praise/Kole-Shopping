    ...
    if($p_fname != '' && $p_mname != '' && $p_lname != '' && $p_email != '' && $p_phone != '' && $p_address != '' && $p_nearB != '' && $p_state != '' && $p_pCode != '' ){
        ...
        if($payMode == 'Cash Payment'){
            ...
            $data = [
                ...
                'redirect_url' => "http://localhost/NIIT-E-COMMERCE-PROJECT/admin/main-admin/admin/verify.php?fname=$p_fname&m_name=$p_mname&l_name=$p_lname&add_phone=$p_add_phone&address=$p_address&add_address=$p_add_address&bustop=$p_nearB&state=$p_state&p_code=$p_pCode"
            ];
        ...
        <div class="row">
            <div class="col-md-10 m-auto">
                <div class="card shadow">
                    <div class="card-header pb-0 px-3 d-flex" style="justify-content: space-between; background: #495057;" >
                        <h6 class="mb-0 text-white">Place Order</h6>
                        <div><a href="order-create.php" class="btn text-white" style="background: #495041;">Back</a></div>
                    </div>
                                    ...
                                    <div class="col-md-7" style="border-left: 1px solid gray;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mt-5">
                                                    <center><button type="submit" name="checkout" class="btn text-white" style="background: #495057;">Purchase Orders!</button></center>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
