        ...
        <div class="card-container row">
            ...
            <div class="form col-md-5">
                ...
                <div class="inputBox">
                    ...
                    <input type="text" maxlength="16" class="card-number-input" name="vcard_number" value="<?= $card['data']['card_number']; ?>">
                </div>
                <div class="inputBox">
                    <span>card holder</span>
                ...
                <input type="submit" value="Update" class="submit-btn" name="updateVcard">
                </form>
            </div>
        </div>
    <?php
