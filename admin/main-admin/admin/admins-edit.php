                   ...
                   <div class="col-md-8">
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="gender" class="form-select" required>
                                    ...
                                    <?php if($admins['data']['gender'] == 'male') : ?>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" maxlength="6" name="postal_code" value="<?= $admins['data']['postal_code']; ?>">
                            </div>
                            </div>
                    ...
                    <div class="card card-profile shadow-sm">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="row">
                                <button class="btn text-white float-end" style="background: #495057;" name="updateAdmin">Save Changes</button>
                            </div>
                        </div>
                        </div>
                    </div> 
