                        ...
                        <div class="row">
                            <div class="col-md-10 m-auto">
                                ...
                                <div class="card-header pb-0 px-3 d-flex" style="justify-content: space-between;">
                                    ...
                                    <div><a href="approved_trx.php" class="btn btn-primary">Back</a></div>
                                </div>
                                        ...
                                        <div class="row">
                                                    <div class="col-md-7">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    <label>Status: </label> <span class="badge bg-success">
                                                                        <?php 
                                                                        if($salary['data']['trx_status'] == 'accept'){
                                                                            echo 'Approved';
                                                                        }else{
                                                                            echo '';
                                                                        }
                                                                ...
                                                                <div class="mb-3">
                                                                    <label>Amount Paid: </label> <span class="small ml-4">N<?= $salary['data']['admin_amount']; ?></span>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    <label>Trx_ID: </label> <span class="small ml-2 "><?= $salary['data']['trx_id']; ?></span>
                                                                </div>
                                                                <div class="mb-3">
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="mt-2">
                                                            <a href="delete_trx.php?id=<?= $salary['data']['id'] ?>"
