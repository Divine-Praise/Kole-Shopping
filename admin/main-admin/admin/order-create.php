  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn text-white saveCustomer" style="background: #495057;">Save</button>
      </div>
    </div>
  </div>
</div>
...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h5 class="m-0 font-weight-bold" style="color: #495057">Create Order
                <a href="#" class="btn text-white float-end" style="background: #495057;">Back</a>
            </h5>
        </div>
        <div class="card-body">
           ...
           <form action="orders-code.php" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3 text-end">
                        <br>
                        <button type="submit" name="addItem" class="btn text-white" style="background: #495057;">Add Item</button>
                    </div>
