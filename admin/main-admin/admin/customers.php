...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h5 class="m-0 font-weight-bold" style="color: #495057">Customers
                <a href="customers-create.php" class="btn float-end text-white" style="background: #495057;">Add Customer</a>
            </h5>
        </div>
        <div class="card-body">
