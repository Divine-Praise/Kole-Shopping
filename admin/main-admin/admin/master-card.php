...
<div class="card-container row">
    ...
    <div class="form col-md-5">
        ...
        <input type="hidden" id="card_type" value="Master card">
        <div class="inputBox">
            <span>card number</span>
            <input type="text" maxlength="16" class="card-number-input" id="mcard_number">
        </div>
        <div class="inputBox">
            <span>card holder</span>
        ...
        <input type="submit" value="submit" class="submit-btn" id="saveMcard">
    </div>
</div>
