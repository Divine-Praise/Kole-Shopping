...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h5 class="m-0 font-weight-bold" style="color: #495057">Edit Customer
                <a href="customers.php" class="btn float-end text-white" style="background: #495057;">Back</a>
            </h5>
        </div>
        <div class="card-body">
            ...
            <?php 
                ...
                if($customer['status'] == 200)
                {
                    ?>
                        ...
                        <input type="checkbox" name="status" style="width: 30px; height:30px;" <?= $customer['data']['status'] == true ? 'checked':''; ?>>
                        </div>

                        <div class="col-md-6 mb-3 text-end">
                        <br>
                        <button type="submit" name="updateCustomer" class="btn text-white" style="background: #495057;">Update</button>
                        </div>
