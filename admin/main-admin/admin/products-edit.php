...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h5 class="m-0 font-weight-bold" style="color: #495057">Edit  Products
                <a href="products.php" class="btn float-end text-white" style="background: #495057;">Back</a>
            </h5>
        </div>
        <div class="card-body">
                    ...
                    if($product){
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3 text-end">
                                <br>
                                <button type="submit" name="updateProduct" class="btn text-white" style="background: #495057;">Update</button>
                            </div>
