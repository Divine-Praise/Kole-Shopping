...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h5 class="m-0 font-weight-bold" style="color: #495057">Print Order</h5>
                        ...
                        if($trackingNo == ''){
                            ?>
                                <div class="text-center py-5">
                                    ...
                                    <div>
                                        <a href="orders.php" class="btn text-white mt-4 w-25" style="background: #495057;">Go Back To Orders</a>
                                    </div>
                                </div>
                            <?php
                        }
                                        ...
                                        <table style="width: 100%;" cellPadding="5">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="1" style="font-weight: bold;">N<?= number_format($row['total_amount'], 0); ?></td>
                                                </tr>
                                                <tr>
