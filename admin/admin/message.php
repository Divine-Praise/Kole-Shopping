...
<div class="row m-0" style="display: flex; justify-content: center; align-items: center;">
    <div class="row mt-4">
        <h6 class="col-md-6 py-3 text-white" style="background: #6f42c1; margin: auto; border-bottom-left-radius: 20px; border-bottom-right-radius: 20px;">
            Message Center
            <div class="float-end">
            ...
            <?php 
                ...
                if(mysqli_num_rows($message) > 0){
                    foreach($message as $msg){
                        ?>
                            <a href="message-proccess.php?id=<?= $msg['id'] ?>" style="text-decoration: none;" name="msgClicked">
