  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn text-white saveCustomer" style="background: #6f42c1;">Save</button>
      </div>
    </div>
  </div>
</div>
...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h5 class="m-0 font-weight-bold" style="color: #6f42c1">Create Order
                <a href="#" class="btn text-white float-end" style="background: #6f42c1;">Back</a>
            </h5>
        </div>
        <div class="card-body">
           ...
           <form action="orders-code.php" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3 text-end">
                        <br>
                        <button type="submit" name="addItem" class="btn text-white" style="background: #6f42c1;">Add Item</button>
                    </div>
    ...
    <div class="card mt-3">
                        ...
                        <table class="table table-bordered table-striped" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>N<?= number_format($item['price'] * $item['quantity'], 0); ?></td>
                                    <td>
        ...
        <div class="pb-5 px-3">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <br/>
                    <button type="button" class="btn w-100 proceedToPlace text-white" style="background: #fd7e14;">Proceed to place order</button>
                </div>
            </div>
        </div>
    </div>
