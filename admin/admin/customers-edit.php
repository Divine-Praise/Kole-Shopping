...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h5 class="m-0 font-weight-bold" style="color: #6f42c1">Edit Customer
            ...
            <?php 
                ...
                if($customer['status'] == 200)
                {
                    ?>
                        ...
                        <br>
                        <button type="submit" name="updateCustomer" class="btn text-white" style="background: #6f42c1;">Update</button>
                        </div>
