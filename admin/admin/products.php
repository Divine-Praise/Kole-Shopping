...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h5 class="m-0 font-weight-bold" style="color: #6f42c1">Products
                <a href="products-create.php" class="btn float-end text-white" style="background: #6f42c1;">Add Product</a>
            </h5>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        <?php foreach($products as $item) : ?>
                            <tr>
                                <td><?= $item['id'] ?></td>
                                <td>
                                    <img src="../main-admin/<?= $item['image']; ?>" style="width: 50px; height: 50px;" alt="Img">
                                </td>
                                <td><?= $item['name'] ?></td>
                                <td>
                                    <?php  
