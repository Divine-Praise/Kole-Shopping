        ...
        <div class="modal-dialog" role="document">
                ...
                <div class="modal-content shadow">
                    <div class="modal-header">
                        <a href="message-view.php?id=<?= $message['data']['id'] ?>" style="text-decoration: none;"><i class="fas fa-fw fa-arrow-left fs-5 text-secondary"></i></a>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn text-white" style="background: #6f42c1;">Send</button>
                    </div>
                </div>
        </div>
    </div>
