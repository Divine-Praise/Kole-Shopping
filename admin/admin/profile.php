                                ...
                                <div class="col-md-8">
                                    <div class="card shadow-sm mb-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="index.php" class="btn text-white btn-sm ms-auto" style="background: #6f42c1;">Back</a>
                                        </div>
                                        </div>
                                        <div class="card-body">
                                    ...
                                    <div class="card card-profile shadow-sm">
                                        ...
                                        <div class="d-flex justify-content-between">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <button class="btn text-white float-end" style="background: #6f42c1;" name="updateProfile">Save Changes</button>
                                                    </div>
                                                </div>
                                        </div>
                                        </div>
