...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h5 class="m-0 font-weight-bold" style="color: #6f42c1">Categories
                <a href="categories-create.php" class="btn float-end text-white" style="background: #6f42c1;">Add Category</a>
            </h5>
        </div>
        <div class="card-body">
